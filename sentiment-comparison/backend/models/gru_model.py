...
class RecurrentNet(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, output_dim, padding_idx):
        ...
        self.rnn = nn.GRU(embedding_dim, hidden_dim, num_layers=2, bidirectional=True, dropout=0.5, batch_first=True)
...
class GRUSentimentModel:
    def __init__(self, artifacts_dir: str = "artifacts") -> None:
        ...
        self.model.load_state_dict(torch.load(os.path.join(artifacts_dir, "gru_model.pth")))
        self.model.eval()
